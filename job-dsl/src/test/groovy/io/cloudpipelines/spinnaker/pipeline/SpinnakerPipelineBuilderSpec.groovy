...
"""
	...
	void setupEnvVars(PipelineDefaults defaults) {
		...
		defaults.addEnvVar("PAAS_TEST_SPACE_PREFIX", "cloudpipelines-test")
		defaults.addEnvVar("PAAS_STAGE_SPACE", "cloudpipelines-stage")
		defaults.addEnvVar("PAAS_PROD_SPACE", "cloudpipelines-prod")
