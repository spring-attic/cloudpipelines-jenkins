...
A deployed version for the Cloud Pipelines demo is available https://sc-pipelines-prometheus.cfapps.io/[here].
...
A deployed version for the Cloud Pipelines demo is available https://sc-pipelines-grafana.cfapps.io/[here]
